...
#
#  $ bin/test -s arkusm.uidfixer.dx -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src arkusm.uidfixer.dx.testing.ARKUSM_UIDFIXER_DX_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/arkusm/uidfixer/dx/tests/robot/test_example.robot
#
